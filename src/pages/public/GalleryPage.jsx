          ...
          <div className="flex flex-wrap justify-center gap-2">
            {categoriesList.map((cat) => (
              <button
                ...
                className={`px-6 py-3 rounded-xl text-[9px] font-black uppercase tracking-[0.2em] transition-all duration-500 whitespace-nowrap ${activeCategory === cat.id
            ...
            <button
              ...
              className={`px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-500 whitespace-nowrap flex items-center gap-3 ${activeCategory === 'channel_feed'
            ...
            {ytVideos.length > 0 && (
              <button
                ...
                className={`px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-500 whitespace-nowrap ${activeCategory === 'live feed'
                    ? 'bg-red-600 text-white shadow-xl scale-105 shadow-red-600/20'
                    : 'text-red-400 hover:text-red-600 hover:bg-red-50'
                  }`}
              >
